...
export default function OrderDetailScreen({ navigation, route }: RootStackScreenProps<'OrderDetail'>) {
    ...
    useEffect(() => {
        const order: IOrder = ordersHistory.find((order: IOrder) => order.id === idOrder);
                    ...
                    <ScrollView>
                        <VStack space='2'>
                            ...
                            <Box rounded='sm' p='2' backgroundColor='white'>
                                ...
                                <Text color='blue.300' fontWeight='bold'>{detailOrder?.status}</Text>
                            </Box>
                        </VStack>
                    </ScrollView>
                    :
