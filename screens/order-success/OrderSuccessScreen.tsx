    ...
    <Box
      ...
      <VStack space='1'>
        ...
        <Text
          ...
          fontWeight='bold'
          color='gray.800'>
          Sewa Barang Berhasil Dilakukan!
        </Text>
        {order.deliveryMethod === "Delivery" ? (
          <Text textAlign='center' color='gray.800'>
            Sekarang, kamu hanya perlu menunggu barangmu dihantar dan
            menyelesaikan pembayaran.
          </Text>
        ) : (
          <Text textAlign='center' color='gray.800'>
            Sekarang, kamu hanya perlu mengambil barangmu dan menyelesaikan
            pembayaran.
          </Text>
        )}
        <Button
        ...
        <Button
          ...
          _text={{ fontWeight: "bold", color: "tertiary.500" }}
          backgroundColor='white'
          px='4'
          onPress={() =>
            navigation.navigate(ROUTES_NAME.ORDER_DETAIL, { idOrder: order.id })
          }>
          Lihat Detail Order
        </Button>
      </VStack>
